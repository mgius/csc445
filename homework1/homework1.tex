...
\intertext{The maximum number of edges in a graph can be expressed as:}
\sum_{1}^{n-1} n &
\intertext{Where n is the number of vertices in the graph. Now, insert this maximum into the original equation:}
